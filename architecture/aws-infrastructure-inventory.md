...
|-------------|-----|--------|----------|---------|
| amplify-dnbackendfunctions-dev-57767-NetworkStack-1WQ2JX5JBEL8C-Cluster-o2oPTAWsP4AL | arn:aws:ecs:us-east-1:<AWS_ACCOUNT_ID>:cluster/amplify-dnbackendfunctions-dev-57767-NetworkStack-1WQ2JX5JBEL8C-Cluster-o2oPTAWsP4AL | **active** | AWS Fargate | Long-running tasks and batch processing |
...
|----------------|-----|---------|
| amplify-dnbackendfunctions-dev-57767-api-channelbackfill-api | <AWS_ACCOUNT_ID>.dkr.ecr.us-east-1.amazonaws.com/amplify-dnbackendfunctions-dev-57767-api-channelbackfill-api | Channel backfill container images |
| amplify-dnbackendfunctions-dev-57767-api-cmscustomidupdate-api | <AWS_ACCOUNT_ID>.dkr.ecr.us-east-1.amazonaws.com/amplify-dnbackendfunctions-dev-57767-api-cmscustomidupdate-api | CMS custom ID cleanup container images |
