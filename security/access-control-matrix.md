  ...
  "Statement": [
    {
      ...
      "Resource": "arn:aws:rds:us-east-1:<AWS_ACCOUNT_ID>:cluster:database-2-cluster"
    },
    {
      "Effect": "Allow",
      "Action": [
      ...
      "Resource": "arn:aws:secretsmanager:us-east-1:<AWS_ACCOUNT_ID>:secret:prod/distronation/*"
    }
  ]
}
```
