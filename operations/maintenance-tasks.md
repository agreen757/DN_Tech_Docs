...
- **Memory**: 4096 MB (4 GB)
- **Container Image**: `<AWS_ACCOUNT_ID>.dkr.ecr.us-east-1.amazonaws.com/<AMPLIFY_PROJECT_NAME>-api-channelbackfill-api:latest`
...
- **Memory**: 8192 MB (8 GB)
- **Container Image**: `<AWS_ACCOUNT_ID>.dkr.ecr.us-east-1.amazonaws.com/<AMPLIFY_PROJECT_NAME>-api-cmscustomidupdate-api:latest`
