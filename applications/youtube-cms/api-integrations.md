...
class YouTubeAPIClient:
    def __init__(self):
        self.ssm_client = SSMClient(region='us-east-1')
        self.key_manager = KeyManager(
            api_id=os.environ.get('API_ID'),
            appSyncClient=AppSyncClient(region='us-east-1'),
...
class APIKeyLifecycleManager:
    def __init__(self):
        self.key_manager = KeyManager(
            api_id=os.environ.get('API_ID'),
            appSyncClient=AppSyncClient(region='us-east-1'),
            ssmClient=SSMClient(region='us-east-1')
        )
...
class EnhancedSecureCredentialManager:
    def __init__(self):
        self.ssm_client = SSMClient(region='us-east-1')
        self.app_sync_client = AppSyncClient(region='us-east-1')
        self.logger = Logger({
  ...
  "Statement": [
    {
      ...
      "Resource": [
        "arn:aws:ssm:us-east-1:*:parameter/distro-nation/appsync/*",
        "arn:aws:ssm:us-east-1:*:parameter/distro-nation/token-api/*"
      ]
    },
    {
      "Effect": "Allow",
