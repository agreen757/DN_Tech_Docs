...
Outbound Rules:
  ...
  Rule 2 - S3 Access:
    ...
    Protocol: TCP
    Port: 443
    Destination: S3 service (com.amazonaws.<REGION>.s3)
...
Public Subnet NACL (proposed):
  Associated Subnets: Public subnets (<REGION>a, 1b, 1c)
...
*This document contains detailed security configuration information. Access is restricted to authorized security and network personnel.*