...
## Overview
This document provides comprehensive documentation of Distro Nation's Virtual Private Cloud (VPC) network topology and configuration within AWS <REGION> region. The network architecture supports a hybrid serverless and traditional infrastructure pattern optimized for media distribution and music industry applications.
...
NAT Gateway Configuration:
  NAT Gateway: nat-gateway-<REGION>b
  Subnet: Public subnet <REGION>b (10.0.2.0/24)
...
Public Route Table (rtb-public):
  Associated Subnets:
    - <REGION>a public (10.0.1.0/24)  
    - <REGION>b public (10.0.2.0/24)
    - <REGION>c public (10.0.3.0/24)
...
Private Route Table (rtb-private):
  Associated Subnets:
    - <REGION>a private (10.0.4.0/24)
    - <REGION>b private (10.0.5.0/24) 
    - <REGION>c private (10.0.6.0/24)
    
  Routes:
    - 10.0.0.0/16 → local (VPC internal traffic)
    - 0.0.0.0/0 → nat-gateway-<REGION>b (outbound internet)
```
...
Single Points of Failure:
  NAT Gateway: ⚠️ Single NAT in <REGION>b
